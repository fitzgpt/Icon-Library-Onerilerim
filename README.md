...
2025 yılı için modern web ve mobil projelerinizde kullanabileceğiniz, tamamen ücretsiz ve açık kaynaklı ikon kütüphanelerinin küratörlüğünü yaptığım kapsamlı bir listedir. 
...
| **Radix Icons** | [icons.modulz.io](https://icons.modulz.io) | Oklar ve tipografi odaklı temiz, profesyonel koleksiyon. |
| **Majesticons** | [majesticons.com](https://www.majesticons.com) | 760 adet yüksek kaliteli, çizgi ve katı stilde ikon seti. |

---

## 🤝 Katkıda Bulunun
Listede olmayan ama kesinlikle olması gerektiğini düşündüğünüz kütüphaneler mi var? Hemen bir **Pull Request** açın veya bir **Issue** oluşturun!

---

## 👨‍💻 Hazırlayan
**FitzGPT** - Twitter: [@fitzgpt](https://twitter.com/fitzgpt)
- GitHub: [FitzGPT](https://github.com/FitzGPT)

---

## 📜 Lisans
Bu proje [MIT](LICENSE) lisansı altındadır. Listelenen kütüphanelerin kendi lisanslarını kontrol etmeyi unutmayın (Genellikle MIT/Apache 2.0).
